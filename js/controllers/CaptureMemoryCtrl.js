angular.module('app').controller("CaptureMemoryCtrl", function($scope,vertxEventBusService,actionData,$stateParams,$state,$filter){
            console.log("entra en CaptureMemoryCtrl");
