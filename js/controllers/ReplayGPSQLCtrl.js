angular.module('app').controller("ReplayGPSQLCtrl", function($scope,vertxEventBusService,actionData,$stateParams,$state,$filter){
            console.log("entra en ReplayGPSQLCtrl");
               ...
               //       }
                   ...
                   /*     if(value===true){
                            vertxEventBusService.send('oracle_Replay_actions', {ID_SES:sessionStorage.idSesion, ID_CON: (actionData.setIdCon()).toString(),VERTX_ACTION:"show_filters",DB_TYPE:"Oracle"}); 
